...
public class ClubeCinemaDBBean {
  ...
  /* private Collection<String> getDiretores(){
   ...
   public void saveFilmeDB() throws SQLException{
       ...
       try{
           comando = conexão.prepareStatement("INSERT INTO Filmes(Titulo, Diretor, Ano, Genero, OscarMelhorFilme) "
                   + " VALUES (?, ?, ?, ?, ?)");
    ...
    public String getFilmesDB() throws SQLException{
       ...
       try{
           comando = conexão.prepareStatement("SELECT Titulo, Diretor, Ano, Genero, OscarMelhorFilme FROM Filmes ORDER BY Ano Desc");
           ...
           while(consultas.next()){
               Filme filme = new Filme(consultas.getString("Titulo"), consultas.getString("Diretor"),
                       consultas.getString("Ano"), consultas.getString("Genero"), consultas.getString("OscarMelhorFilme"));
               filmes.add(filme);
           }
           consultas.close();
           comando.close();
